...
def copy_grid(grid):
    global input_grid
    input_grid = [[0 if v is None else v for v in row] for row in xw.Range('A1:I9').value]
    xw.Range('P1').value = [['' if v is None else v for v in row] for row in xw.Range('A1:I9').value]
